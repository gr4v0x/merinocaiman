...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='mainiden',
            name='idenType',
            field=models.CharField(choices=[('witness', 'Witness'), ('informant', 'Informant'), ('suspect', 'Suspect'), ('enabler', 'Enabler')], max_length=64, null=True),
        ),
        migrations.AddField(
            model_name='notebook',
            name='noteDate',
